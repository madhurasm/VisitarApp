            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
{{--                            <div class="text-end">--}}
{{--                                <a href="{{route('admin.hosts.create')}}" class="btn btn-primary waves-effect btn-label waves-light"><i class="bx bx-plus label-icon"></i> Add</a>--}}
{{--                            </div>--}}
                            @if(Auth::user()->type == 'admin')
                                <div class="row mb-3 align-items-end">
                                    <!-- Filter on the Left Side -->
                                    <div class="col-md-3">
                                        <label class="col-form-label">Filter Entity</label>
                                    ...
                                    <div class="col-md-7 text-end">
                                        <a href="{{route('admin.hosts.create')}}" class="btn btn-primary waves-effect btn-label waves-light">
    ...
    <script>
        $(function() {
            ...
            $('#apply_filter').on('click', function (){
                ...
                oTable.ajax.url("{{ route('admin.hosts.index') }}?entity_filter=" + entity_filter).load();
            });
        });
    </script>
@endsection
